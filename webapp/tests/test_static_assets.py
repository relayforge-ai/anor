...
class TestStaticProgressUI(unittest.TestCase):
    ...
    def test_js_has_progress_helpers(self):
        ...
        for needle in (
            ...
            'key === "["',
            'key === "]"',
            "Auto-next on — after a full cut, advance in 3s",
            "Resume ${pct}%",
        ...
        self.assertIn("<kbd>,</kbd>/<kbd>.</kbd> or <kbd>1</kbd>–<kbd>4</kbd> speed", html)
        self.assertIn("<kbd>0</kbd> 1×", html)
